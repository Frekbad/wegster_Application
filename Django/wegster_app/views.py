...
#         response = JsonResponse({'message': 'Image uploaded successfully.'})
#         csrf.get_token(request)  # Include the CSRF token in the response
#         return response

#     # Return an error response if the request method or file is invalid
