// ignore_for_file: use_build_context_synchronously, unused_label, unused_local_variable, prefer_const_constructors, sized_box_for_whitespace, non_constant_identifier_names, sort_child_properties_last, unused_import, depend_on_referenced_packages, avoid_print, duplicate_ignore
...
import 'package:wegster_application/themes/app_themes.dart';
...
//import 'package:wegster_application/bloc/theme/theme_bloc.dart';
...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  FetchHotelLocation local = FetchHotelLocation();
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: SingleChildScrollView(
            ...
            Center(
                child: FutureBuilder(
              future: local.getHotelLocation(query: user.address),
