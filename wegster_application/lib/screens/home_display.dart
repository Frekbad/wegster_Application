// ignore_for_file: public_member_api_docs, sort_constructors_first, non_constant_identifier_names, unused_local_variable, sized_box_for_whitespace, unnecessary_string_interpolations, unnecessary_new, avoid_types_as_parameter_names, avoid_unnecessary_containers, prefer_const_constructors, unused_import
import 'dart:convert';
...
import 'package:wegster_application/screens/Roombookings.dart';
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Row(
                                                                            children: [
                                                                              ...
                                                                              Text(
                                                                                "$Customer_Name",
                                                                                style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, fontFamily: 'ProximaNova', color: DMColors.blackColor),
                                                                              ),
                                                                            ],
                                                                          ),
                                                                          SizedBox(
